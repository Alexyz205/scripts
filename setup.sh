...
common_items=(
  ...
  "config/git/config:$XDG_CONFIG_HOME/git/config"
  "config/delta/catppuccin.gitconfig:$XDG_CONFIG_HOME/delta/catppuccin.gitconfig"
  ...
  "config/yazi/theme.toml:$XDG_CONFIG_HOME/yazi/theme.toml"
  "config/eza/theme.yml:$XDG_CONFIG_HOME/eza/theme.yml"
  "config/bat/config:$XDG_CONFIG_HOME/bat/config"
  "config/bat/themes:$XDG_CONFIG_HOME/bat/themes"
...
create_symlinks "${common_items[@]}" || log_warning "Some symlinks failed to create, but continuing setup"
...
echo "  - AI Assistant - OpenCode configuration"
echo "  - File Manager - Yazi configuration"
echo "  - File Listing - Eza configuration"
echo "  - Syntax Highlight - Bat configuration"
echo "  - Diff Viewer - Delta configuration"
